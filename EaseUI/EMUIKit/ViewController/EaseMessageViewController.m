...
#import "JEAgreeRoadTableViewCell.h"
...
@interface EaseMessageViewController ()<EaseMessageCellDelegate,JECheckRoadTableViewCellDelegate>
{
...
-(UITableViewCell *)rewardTableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    static NSString *cellID =@"JECheckRoadTableViewCell";
    JECheckRoadTableViewCell *cell =[tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
...
-(UITableViewCell *)agreeTableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    static NSString *cellID =@"JEAgreeRoadTableViewCell";
    JEAgreeRoadTableViewCell *cell =[tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell =[[[NSBundle mainBundle] loadNibNamed:cellID owner:self options:nil] lastObject];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[NSString class]]) {
        ...
        id<IMessageModel> tempModel = object;
        EMMessage *message =tempModel.message;
        
        
        NSLog(@"message to --->%@  message.text ---->%@",message.to,model.text);
     
            if ([tempModel.text isEqualToString:@"123456"]) {
                
                return  [self rewardTableView:tableView cellForRowAtIndexPath:indexPath];
            }
        
  
        if ([tempModel.text isEqualToString:@"11111"]) {
            
            
            return  [self agreeTableView:tableView cellForRowAtIndexPath:indexPath];
...
//        if (_countNumber == 1000) {
//            NSString *CellIdentifier = [JECheckRoadTableViewCell cellIdentifierWithModel:model];
//            //CustomMessageCell为用户自定义cell,继承了EaseBaseMessageCell
//            JECheckRoadTableViewCell *cell = (JECheckRoadTableViewCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
//            if (cell == nil) {
//                cell = [[JECheckRoadTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier model:model];
...
//            
//            cell = [tableView dequeueReusableCellWithIdentifier:@"JECheckRoadTableViewCell"];
//            if (cell == nil) {
//                cell =  [[[NSBundle mainBundle] loadNibNamed:@"JECheckRoadTableViewCell" owner:self options:nil] lastObject];
//            }
//      
//            return cell;
//
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[NSString class]]) {
        ...
        id<IMessageModel> model = object;
            ...
            if ([model.text isEqualToString:@"123456"]) {
                return 180;
            }
            if ([model.text isEqualToString:@"agreeRoad"]){
                return 180;
            }
...
//        //CustomMessageCell为用户自定义cell,继承了EaseBaseMessageCell
//        return [JECheckRoadTableViewCell cellHeightWithModel:messageModel];
//    }
//    return 0.f;
//}
#pragma mark---tabview button delegate
...
-(void)tableViewCell:(JECheckRoadTableViewCell *)cell agreeRoad:(UIButton *)button{
    ...
    [self sendTextMessage:@"agreeRoad"];
