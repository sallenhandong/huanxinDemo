...
- (void)_setupBarButtonItem
{
    ...
    [backButton setImage:[UIImage imageNamed:@"zuojiantou.png"] forState:UIControlStateNormal];
                           ...
                           modelForMessage:(EMMessage *)message
{
    ...
    if ([currentName isEqualToString:msgName]) {
        ...
        model.nickname = @"那是一条鱼";
        model.avatarURLPath = @"http://cdnq.duitang.com/uploads/item/201507/06/20150706120524_NQ8LU.thumb.224_0.png";
